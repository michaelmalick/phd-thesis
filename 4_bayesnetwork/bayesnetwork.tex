...
% \chapter[Environmental Pathways and Salmon Recruitment]
...
transition occurred early (thick black curve in Fig. \ref{fig:bn:8}a). This
difference in steepness corresponded to an 81\% chance recruitment would be
...
considerably less steep (thick grey curve in Fig. \ref{fig:bn:8}b) than when the
prey resource indices were below average (thick black curve in Fig.
...
curve in Fig. \ref{fig:bn:8}b) was moderately steeper compared to when
ichthyoplankton biomass was above average and copepod biomass was below average
(grey dashed curve in Fig. \ref{fig:bn:8}b).
...
\begin{table}[!ht]
  ...
  \input{./4_bayesnetwork/tables/R_S_p3e_b3e_table_path_strength.tex}
  \label{tab:bn:s1}
\end{table}
