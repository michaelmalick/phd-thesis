...
\chapter[Quantifying ecological network effects]{Accounting for multiple
  pathways in the connections among climate variability, ocean processes, and
  coho salmon recruitment in the Northern California Current\footnotemark[1]}
\label{ch:bn}
...
\begin{table}[htbp]
  ...
  \label{tab:bn:s1}
\end{table}
\clearpage % force tables to come prior to figures
