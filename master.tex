...
% TODO convert long tables --> tabular if the table is a single page
% TODO integrate supporting materials to main text if no text?
% TODO floating tables and figures
